...
namespace RPG.MyAnimation
{
    public class AnimationMixerBehaviour : AnimationBehaviour
    {
        ...
        public void Init(PlayableGraph graph, ScriptPlayable<AnimationMixerBehaviour> playable)
        {
            Init(graph);
        ...
        public override void Enable()
        {
            ...
            playable.Play();
            animationMixerPlayable.Play();

            for (int i = 0; i < animationMixerPlayable.GetInputCount(); i++)
            {
                AnimationTool.Enable(animationMixerPlayable.GetInput(i));
            }
        }
